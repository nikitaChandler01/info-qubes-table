<template>
  <div class="bar">
    <DataTable :value="rows" stripedRows class="p-datatable-table">
      <Column field="name" header="Категории" />
      <Column field="script" header="Scripts" />
      <Column field="restictions" header="Restictions" />
      <Column field="courtesy" header="Courtesy" />
    </DataTable>
  </div>
  <ParametersPage />
</template>
...
<script setup>
//TODO: добавить vue-router
// scriptParameters прокинуть в ParametersPage через props
